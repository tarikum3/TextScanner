...
import com.tarikum3.tryocr.utils.imageFolder;
import com.tarikum3.tryocr.utils.itemClickListener;
import com.tarikum3.tryocr.utils.pictureFacer;
import com.tarikum3.tryocr.utils.pictureFolderAdapter;
...
public class MainActivity2 extends AppCompatActivity implements itemClickListener {
    ...
    public static final String PATH_SELECTED2 =
            "com.tarikum3.tryocr.extra.pathselected2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(folds.isEmpty()){
            ...
            RecyclerView.Adapter folderAdapter = new pictureFolderAdapter(folds,MainActivity2.this,this);
    ...
    public void onPicClicked(String pictureFolderPath,String folderName) {
        Intent move = new Intent(MainActivity2.this,ImageDisplay.class);
        move.putExtra("folderPath",pictureFolderPath);
        move.putExtra("folderName",folderName);

        //move.putExtra("recyclerItemSize",getCardsOptimalWidth(4));
       // startActivity(move);
        startActivityForResult(move, PATH_REQUEST);
    }
   ...
   public void onActivityResult(int requestCode, int resultCode, Intent data) {
       ...
       if (requestCode == PATH_REQUEST) {
           // Test to make sure the intent reply result was good.
           if (resultCode == RESULT_OK) {
               String [] path = data.getStringArrayExtra(ImageDisplay.PATH_SELECTED);

               Intent replyIntent = new Intent();
               replyIntent.putExtra(PATH_SELECTED2, path);
